...
public class OssOperationCommands implements CommandMarker {
     ...
     * @return content
     */
    @CliCommand(value = "set", help = "Set object meta data")
    public String set(@CliOption(key = {""}, mandatory = true, help = "file name and meta data") final String bucketName) {
        this.currentBucket = bucketName;
        return "Switched to " + bucketName + StringUtils.LINE_SEPARATOR;
    }
}